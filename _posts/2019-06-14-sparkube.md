...
![Creation wizard]({{ site.url }}assets/imgs/AKS_1.PNG?raw=true)
<img src="{{ site.url }}assets/imgs/AKS_1.PNG" alt="drawing" width="200"/>

![Scale]({{ site.url }}assets/imgs/AKS_2.PNG?raw=true)

![RBAC]({{ site.url }}assets/imgs/AKS_3.PNG?raw=true)

![Network]({{ site.url }}assets/imgs/AKS_4.PNG?raw=true)

![Tags]({{ site.url }}assets/imgs/AKS_5.PNG?raw=true)
...
![Access Control (IAM)]({{ site.url }}assets/imgs/AKS_6.PNG?raw=true)
...
After a successful authentication the `~/.kube/config` file will appear, containing the OAuth access token among others. Extract it with the following:
```bash
